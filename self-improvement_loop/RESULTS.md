...
## Verdict
✅ **Edge confirmed** — rolling MAPE 0.93% beats the random-walk baseline 0.95% by 0.02%.

**Today's open prediction (2026-09-11):** close ≈ **251.72** (down, confidence 54.00%) vs prior close 251.89.
...
|---|---|---|
| Scored days | 20 | 63 |
| PASS rate (±1%) | 65.00% | 44.44% |
| Directional accuracy | 55.00% | 50.79% |
| MAPE | 0.93% | 1.57% |
| Baseline MAPE (random walk) | 0.95% | 1.54% |
...
|---|---|---|---|---|
| news | 63 | 26.98% | 1.40% | 0.22 |
| technical | 63 | 17.46% | 1.44% | 0.21 |
| contrarian | 63 | 19.05% | 1.61% | 0.19 |
| momentum | 63 | 23.81% | 1.62% | 0.19 |
| macro | 63 | 12.70% | 1.64% | 0.19 |
...
**Verdict:** Arm B leads on paired MAPE (mean daily delta 0.09% in B's favor); B wins 21/38 decisive days (sign test p=0.6271, not significant).

**B's open prediction (2026-09-11):** close ≈ **252.29** (up, adj 0.1σ, 7 evidence items).

| Rolling metric | A — ensemble+gates | B — raven prior+pulse |
|---|---|---|
| Scored days | 20 | 20 |
| PASS rate (±1%) | 65.00% | 60.00% |
| Directional accuracy | 55.00% | 55.00% |
| MAPE | 0.93% | 1.00% |
| Edge vs baseline | 0.02% | -0.05% |

Paired days: 38; B wins 21/38 decisive; mean daily APE delta (A−B) 0.09%; sign test p = 0.6271.
