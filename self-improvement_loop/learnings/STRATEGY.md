...
- (2026-08-20) After a single-day bounce >2% that follows a multi-day selloff, weight contrarian/technical mean-reversion signals higher than news/momentum when RSI>65 and price >5% above SMA50 — test whether fading corrective bounces beats continuation.
- (2026-08-21) When momentum and technical agree on direction with price below SMA-5 and RSI<45, down-weight news' premarket-gap claims unless corroborated by a second intraday source — test whether trusting the technical/momentum consensus lifts directional hit-rate.